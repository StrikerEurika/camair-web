  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-1">
        ...
        <span className="text-xs font-mono font-semibold text-white">{value.toFixed(2)} <span className="text-slate-500">{unit}</span></span>
      </div>
      ...
      <CardContent className="pt-5">
        ...
        <div className="flex items-start justify-between mb-4">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-slate-500">Selected Province</span>
            </div>
        ...
        <div className="grid grid-cols-2 gap-3 mt-5">
          <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-3 text-center">
            ...
            <p className="text-2xl font-bold text-white">{record.us_epa_index}</p>
          </div>
          <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-3 text-center">
            <p className="text-[10px] uppercase tracking-wider text-slate-500 mb-1">GB DEFRA</p>
            <p className="text-2xl font-bold text-white">{record.gb_defra_index}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 mt-4 pt-4 border-t border-white/[0.06]">
          ...
          <span className="text-[10px] text-slate-600">Last updated: {record.last_updated}</span>
        </div>
      </CardContent>
    </Card>
  );

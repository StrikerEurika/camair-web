...
import type { WeatherCity, AirQualityData, RainChanceData, UVIndexData } from '@/types/weather';
...
const mockCities: WeatherCity[] = [
  {
    ...
    forecasts: [
      ...
      { date: '16', day: 'Tue', temp: 27, condition: 'partly-cloudy', icon: '⛅' },
      { date: '17', day: 'Wed', temp: 29, condition: 'partly-cloudy', icon: '⛅' },
  ...
  },
  {
    ...
    forecasts: [
      ...
      { date: '17', day: 'Wed', temp: 30, condition: 'partly-cloudy', icon: '⛅' },
  ...
  },
  {
    ...
    forecasts: [
      ...
      { date: '16', day: 'Tue', temp: 23, condition: 'partly-cloudy', icon: '⛅' },
  ...
  },
  {
    ...
    forecasts: [
      ...
      { date: '15', day: 'Mon', temp: 33, condition: 'partly-cloudy', icon: '⛅' },
      { date: '16', day: 'Tue', temp: 31, condition: 'rainy', icon: '🌧️' },
      { date: '17', day: 'Wed', temp: 30, condition: 'rainy', icon: '🌧️' },
      { date: '18', day: 'Thu', temp: 32, condition: 'partly-cloudy', icon: '⛅' },
      { date: '19', day: 'Fri', temp: 34, condition: 'sunny', icon: '☀️' },
          ...
          <main className="flex-1">
            ...
            <div className="flex items-center justify-end gap-3 mb-6">
              <div className="flex items-center bg-white dark:bg-slate-800/50 rounded-full border border-slate-200 dark:border-slate-700 px-4 py-2 transition-colors">
                <span className="text-sm text-slate-600 dark:text-slate-300 font-medium">📅 10-day</span>
              </div>

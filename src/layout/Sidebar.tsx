...
const navItems = [
  ...
  { icon: AirVent, label: "Air Quality", active: true },
...
export function Sidebar() {
  return (
    <aside className="sticky h-full top-8 w-full md:w-20 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl flex flex-row md:flex-col items-center py-4 md:py-6 px-4 md:px-0 gap-6 shadow-sm dark:shadow-none transition-all duration-300">
      {/* Logo */}
